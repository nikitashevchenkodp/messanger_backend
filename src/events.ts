...
export const TYPING_ON = 'typing';
export const MESSAGE_RECIEVED = 'messageRecieved';
export const MESSAGE_DELIVERED_ON = 'messageDelivered';
export const DISCONECTED = 'disconnect';
